...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Auth Application</h1>\n  <p>Welcome to our application, please join us by pressing regiser button or log in if you already registered.</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n    <a class=\"btn btn-success\" [routerLink]=\"['/login']\">Log In</a>\n  </div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Welcome to dashboard', { cssClass: 'alert-success', timeout: 3000 });
            }
            else {
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(user)) {
            this.flashMessage.show('Please enter valid information!', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // Validate Email
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Operation success!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('Operation unsuccess!', { cssClass: 'alert-danger', timeout: 3000 });
